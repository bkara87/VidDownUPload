...
from src.config import APP_NAME, APP_VERSION, DOWNLOADS_DIR, PROCESSED_DIR, GITHUB_OWNER, GITHUB_REPO
...
from src.ui.styles import (
    COLOR_BG_DARK, COLOR_CARD_BG, COLOR_PRIMARY, COLOR_PRIMARY_HOVER,
    COLOR_SUCCESS, COLOR_WARNING, COLOR_TEXT_MAIN, COLOR_TEXT_MUTED, COLOR_CARD_BORDER
)
...
class MainWindow(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        subtitle_label = ctk.CTkLabel(
            header,
            text="Instagram • YouTube • TikTok Video İndirme ve Filigran Maskeleme",
        ...
        self.entry_url = ctk.CTkEntry(
            card_download,
            placeholder_text="Video veya Sayfa Bağlantısını Yapıştırın (Instagram / YouTube / TikTok)",
            height=40,
            corner_radius=8
        )
        ...
        pub_info = ctk.CTkLabel(
            card_pub,
            text="ℹ️ Otomatik paylaşım modülü geçici olarak pasif tutulmaktadır.\nİşlenen videolar çıktısı bilgisayarınıza kaydedilir.",
            font=ctk.CTkFont(size=12),
    ...
    def _process_task(self):
        ...
        if self.chk_mask.get():
            # Example default box coordinates (x, y, w, h) for video height/width
        ...
        self.btn_process.configure(state="normal", text="Filigranı İşle ve Kaydet")
