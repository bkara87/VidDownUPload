...
def build_installer():
    ...
    print("\n==========================================")
    print("4. Derleniyor: Setup Installer (VidDownUPload_Setup_v1.0.0.exe)")
    print("==========================================")
    installer_cmd = [
        python_exe, "-m", "PyInstaller",
        "--noconfirm",
    ...
    setup_exe = BASE_DIR / "dist" / "VidDownUPload_Setup_v1.0.0.exe"
    print("\n==========================================")
